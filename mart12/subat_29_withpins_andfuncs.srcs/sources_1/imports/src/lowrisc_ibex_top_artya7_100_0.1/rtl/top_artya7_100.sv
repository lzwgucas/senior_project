...
//    output logic [7:0] AN
//    output logic [31:0] pc_id_ila_top //eklendi 10 mart (ila'ya bağlamak için)
);
...
logic [31:0] ram_data_top ;
    ...
    logic [31:0] pc_id_ila;
         ibex_core #(
            ...
            .fetch_enable_i        ('b1),
            .core_sleep_o          (),
            .pc_id_ila(pc_id_ila) //eklendi 10 mart (ila'ya bağlamak için)
         );
  ...
  //eklendi 9 mart 2020
//  logic trig_out;
//  logic trig_out_ack_reg; 
  logic [31:0] clk_sys_counter= 32'b0;
// always@(negedge IO_RST_N) begin
